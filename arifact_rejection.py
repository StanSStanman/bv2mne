...
def GUI_plot(RMS, save=False):
    ...
    if type(save) == str:
        d = {'bad_chans': bad_channels, 'bad_trials': bad_trials}
        np.savez(op.join(save, 'artifact_rejection.npz'), d=d)
